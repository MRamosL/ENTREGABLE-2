...
<body>
   ...
   <!--  <a href="views/registroprofesor.php" class="btn btn-primary">Agregar Nuevo</a> -->
    <div>
        ...
        <?php
            while($row = mysqli_fetch_assoc($result)){
                ...
                <tr>
                    ...
                    <td>{$row['enable']}</td>
                    <td>
                        <a href='#insertarRegistroModal' data-bs-target='#insertarRegistroModal' class='btn btn-warning' onclick='openEditar({$row['id']})'>
    ...
    <?php
        // Manejar la solicitud de obtener detalles del profesor
                ...
                <form action="index.php?page=insertar" method="POST" name="registroForm" id="registroForm" class="text-left">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <small id="emailHelp" class="form-text text-muted">Ingrese el correo electrónico del profesor.</small>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
   ...
   <!-- Modal editar -  -->
    ...
    <!-- Modal editar -->
    <div class="modal fade" id="editarRegistroModal" tabindex="-1" role="dialog" aria-labelledby="agregarDatosModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="agregarDatosModalLabel">Editar nuevos registros</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <!--<span aria-hidden="true">&times;</span>-->
                    </button>
                </div>
