...
<body>
    ...
    <div>
        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#insertarModal">Agregar Proyectos </button>
    </div><br>
    ...
    document.getElementById("formularioInsertar").addEventListener("submit", function(event) {
        ...
        xhr.onload = function() {
            if (xhr.status >= 200 && xhr.status < 400) {
                ...
                alert("Proyecto insertado exitosamente.");
            } else {
                // Error: Mostrar mensaje de error
                alert("Error al insertar el nuevo Proyecto.");
            }
        };
